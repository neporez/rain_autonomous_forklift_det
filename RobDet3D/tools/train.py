...
def add_args():
    ...
    parser.add_argument('--pretrained_ckpt', type=str, default=None, help='pretrained_model_ckpt_path')
...
def parse_config(args):
    ...
    run_cfg.pretrained_ckpt = args.pretrained_ckpt
...
if __name__ == '__main__':
    ...
    if cfg.RUN.pretrained_ckpt is not None:
        checkpoint.load_from_file(cfg.RUN.pretrained_ckpt, model)
