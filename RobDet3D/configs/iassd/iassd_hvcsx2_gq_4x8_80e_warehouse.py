from ..base.datasets.warehouse_point_32768_ped import *
from ..base.runtime.adam_onecycle_4_80e_ver2 import *
...
MODEL = dict(
    ...
    BACKBONE_3D=dict(
        ...
        ENCODER=
        [
            dict(samplers=[dict(name='hvcs_for_query', sample=8192, voxel=[0.95, 0.95, 0.725])],
            ...
            dict(samplers=[dict(name='hvcs_for_query', sample=2048, voxel=[3, 3, 2.5])],
            ...
            dict(samplers=[dict(name='ctr', sample=1024, mlps=[128], class_name=DATASET.CLASS_NAMES,
    ...
    POINT_HEAD=dict(
        ...
        VOTE_SAMPLER=dict(name='ctr', sample=512, mlps=[256], class_name=DATASET.CLASS_NAMES,
                          train=dict(target={'extra_width': [0.5, 0.5, 0.5]},
        ...
        BOX_CODER=dict(name='PointBinResidualCoder', angle_bin_num=12,
                       use_mean_size=True, mean_size=[[0.7, 0.7, 1.75],]),
